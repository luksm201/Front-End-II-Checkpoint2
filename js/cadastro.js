...
// DIV VISUALIZADA
function trocaDiv() {
  document.getElementById('registrationPage1').addEventListener('click', () => {
...
function validar_nome() {
  ...
  if ((nome.length <= 10) ||
    ...
    alert("Campo 'Nome' deve ser preenchido corretamente.");
    return false;
  } else {
    return true;
  }
...
function validar_email() {
  ...
  if ((usuario.length >= 1) &&
    ...
    alert("Campo Email deve ser preenchido corretamente.")
    return false;
  }
}
...
/* Importando 15 primeiras da API */
let importarTarefas = _ => {

}

// EVENTO AO BOTÃO CADASTRAR
